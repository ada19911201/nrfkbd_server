...
const keycodes = {
	...
	RGB_B_TOG: new Keycode('RGB_B_TOG', 'RGB_B_TOG', []),
	RGB_B_STEP: new Keycode('RGB_B_STEP', 'RGB_B_STEP', []),
	RGB_B_STEP_R:new Keycode('RGB_B_STEP_R', 'RGB_B_STEP_R', []),
	RGB_B_HUI:new Keycode('RGB_B_HUI', 'RGB_B_HUI', []),
	RGB_B_HUD:new Keycode('RGB_B_HUD', 'RGB_B_HUD', []),
	RGB_B_SAI:new Keycode('RGB_B_SAI', 'RGB_B_SAI', []),
	RGB_B_SAD:new Keycode('RGB_B_SAD', 'RGB_B_SAD', []),
	RGB_B_VAI:new Keycode('RGB_B_VAI', 'RGB_B_VAI', []),
	RGB_B_VAD:new Keycode('RGB_B_VAD', 'RGB_B_VAD', []),
	RGB_M_TOG:new Keycode('RGB_M_TOG', 'RGB_M_TOG', []),
	RGB_M_STEP: new Keycode('RGB_M_STEP', 'RGB_M_STEP', []),
	RGB_M_STEP_R: new Keycode('RGB_M_STEP_R', 'RGB_M_STEP_R', []),
	RGB_M_HUI:new Keycode('RGB_M_HUI', 'RGB_M_HUI', []),
    RGB_M_HUD:new Keycode('RGB_M_HUD', 'RGB_M_HUD', []),
    RGB_M_SAI:new Keycode('RGB_M_SAI', 'RGB_M_SAI', []),
    RGB_M_SAD:new Keycode('RGB_M_SAD', 'RGB_M_SAD', []),
    RGB_M_VAI:new Keycode('RGB_M_VAI', 'RGB_M_VAI', []),
    RGB_M_VAD:new Keycode('RGB_M_VAD', 'RGB_M_VAD', []),
    RGB_M_SPI:new Keycode('RGB_M_SPI', 'RGB_M_SPI', []),
    RGB_M_SPD:new Keycode('RGB_M_SPD', 'RGB_M_SPD', []),
